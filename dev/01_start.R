...
golem::fill_desc(
  pkg_name = "bdchecks.app", # The Name of the package containing the App 
  pkg_title = "Graphical Interface for bdchecks App", # The Title of the package containing the App 
  pkg_description = "Shiny App giving complete workflow to selectively perform datachecks.", 
  ...
  repo_url = "https://github.com/bd-R/bdchecks.app" # The (optional) URL of the GitHub Repo
)     
